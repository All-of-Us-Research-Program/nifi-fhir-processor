...
public class MyProcessorTest {
    ...
    public void init() throws IOException {
        ...
        patient_ex = new String(Files.readAllBytes(Paths.get("patient-example-f201-roel.txt")));
        patient_ex_valid_resource = new String(Files.readAllBytes(Paths.get("patient-example-f201-roel-parsed.txt")));
        patient_ex_summary = new String(Files.readAllBytes(Paths.get("patient-example-f201-roel-summary-mode.txt")));
